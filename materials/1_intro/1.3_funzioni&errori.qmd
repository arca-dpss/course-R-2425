...
#creo un vettore campionando 1000 elementi 
# da una distribuzione normale con media 0 e sd 1
myvec = rnorm(n = 1000, mean = 1, sd = 1)

mean(x = myvec) # x definito,trim e na.rm non definito, quindi uguali a?
?mean
```
...
![](images/stackOver.png){fig-align="center" width="600"}
