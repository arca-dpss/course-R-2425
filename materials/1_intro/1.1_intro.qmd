...
1.  Scarica il file [prova.csv](https://github.com/arca-dpss/course-R-2425/blob/main/materials/1_intro/prova).
...
```{r, echo=TRUE, warning=FALSE}
read.csv("/Users/tita/course-R-2425/materials/1_intro/prova.csv")
```
