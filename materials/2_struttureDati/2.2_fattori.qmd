...
```{r, echo=TRUE}
new_fact = factor(x = my_fact, levels = c("hello","ciao","hola"))
new_fact
as.integer(new_fact)
```
:::
...
Possiamo anche rinominare i livelli sempre attraverso la funzione `factor()`:

```{r, echo=TRUE}
my_fact

new_fact2 = factor(x = my_fact, levels = c("hello","ciao","hola"),
